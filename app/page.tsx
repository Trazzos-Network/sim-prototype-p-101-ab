...
export default function PumpSimulation() {
  ...
  const showMaintenance =
    currentFrame >= MAINTENANCE_FRAME && currentFrame < MAINTENANCE_FRAME + 12;

  return (
    <div className="min-h-screen bg-background p-4">
      <div className="max-w-[1800px] mx-auto space-y-4">
        {/* Header */}
        <div className="bg-card rounded-lg p-4 border border-border flex items-start justify-between">
          <div>
            <h1 className="text-2xl font-bold text-foreground mb-1">
              Simulación de Bomba Industrial - P-101 A/B
            </h1>
            <p className="text-muted-foreground text-sm">
              Visualización interactiva de datos de sensores de 14 días
              demostrando el valor del mantenimiento predictivo
            </p>
          </div>
          <Image
            src="images/logo-trazzos.svg"
            alt="Logo"
            width={200}
            height={100}
          />
