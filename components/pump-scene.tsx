    ...
    const sketch = (p: p5) => {
      ...
      p.draw = () => {
        ...
        const scale = Math.max(
          p.width / REFERENCE_WIDTH,
          p.height / REFERENCE_HEIGHT
        );
      ...
      function drawSideView(p: p5, s: number, rot: number) {
        ...
        drawSensor(
          ...
          -132 * s,
          "VIB-01",
          currentData.vibration.toFixed(2)
        );
        drawSensor(
          p,
          s,
        ...
        drawSensor(
          ...
          -124 * s,
          "CT-101",
          currentData.motorCurrent.toFixed(1)
        );
      ...
      function drawStatusIndicator(
        ...
        const activeColor =
          colors[status as keyof typeof colors] || colors.normal;
